    ...
    return (
        <div className="flex block flex-wrap h-screen">
            <article className="mt-20 w-full justify-center text-center">
                <BetterLetters words="Drop me a line!" custom="text-7xl ae-text-outline" />
            </article>
            <section className="w-full border-lime-600 text-white flex flex-wrap flex-row justify-center">
                <div className="py-6 px-6 lg:px-8 border w-8/12 rounded-3xl">
                    ...
                    >
                        <input
                            type="text"
                            name="Name"
                            className="border bg-transparent border-lime-500 text-white text-sm rounded-full focus:ring-lime-500 focus:border-lime-500 block h-20 resize-y w-full md:w-8/12 p-2.5 autofill:bg-black"
                            placeholder="Name"
                            id="author"
                            max="100"
                            required
                        ...
                        <div className="flex flex-wrap ">
                            <div className="w-full md:w-9/12">
                                <textarea
                                    name="Message"
                                    className="border bg-transparent border-lime-500 text-white text-sm rounded-3xl h-96 resize-y focus:ring-lime-500 focus:border-lime-500 w-full mb-16"
                                    placeholder="Message"
                                    id="header"
                                    required
                                    maxLength={280}
