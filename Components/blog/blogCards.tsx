...
export const BlogCards: React.FC = () => {
    ...
    const renderCards = () => {
        return blogPost.map((blog: BlogType) => {
                ...
                >
                    <div>
                        <div className="shadow h-64 rounded-full relative">
                            <Link href={`/blog/${blog._id}`} className="href">
                                <a>
                                    <Image
                                        src={blog.img}
                                        alt="STUFF"
                        ...
                        <div className="p-6 w-11/12 mx-auto -mt-24 bg-gray-900 rounded-3xl z-20 relative mb-4">
                            ...
                            <h3 className="text-sm text-white text-center">
                                {postDate} by{" "}
                                <a href="https://github.com/andrew87e">
                                    <span className="text-lime-500 cursor-pointer hover:text-blue-600">
                                        {blog.author}
                                    </span>
                                </a>
                            </h3>
